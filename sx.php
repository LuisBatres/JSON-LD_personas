<?php
if(file_exists('RNPEDFC.json'))
{
	$filename = 'RNPEDFC.json';
...
<header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6" href="#">PERSONAS EXTRAVIADAS JSON-LD</a>
  ...
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">PERSONAS EXTRAVIADAS</h1>
...
?>
    ...
    <div class="table-responsive">
      <table class="table table-striped table-sm">
        ...
        <tbody>
        <?php
          // Iterar sobre los resultados en la página actual
          for ($i = $startIndex; $i <= $endIndex && $i < $totalResults; $i++) {
            $user = $users[$i];
        ?>
            <tr>
              <td><?= $i + 1 ?></td>
    ...
    <nav aria-label="Page navigation">
      <ul class="pagination">
        <?php
          // Mostrar enlace para la primera página
          if ($currentPage > 1) {
        ?>
            <li class="page-item">
        ...
        <?php
          ...
          // Mostrar enlaces para las páginas intermedias
        ...
        ?>
            <li class="page-item <?= $activeClass ?>"><a class="page-link" href="?page=<?= $page ?>"><?= $page ?></a></li>
        <?php
          }
    ...
    <p>Mostrando resultados <?= $startIndex + 1 ?> - <?= min($endIndex + 1, $totalResults) ?> de <?= $totalResults ?></p>
...
?>
    ...
    <script src="/docs/5.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-ENjdO4Dr2bkBIFxQpeoTz1HIcje39Wm4jDKdf19U8gI4ddQ3GYNS7NTKfAdVQSZe" crossorigin="anonymous"></script>
	  ...
	  <script>
		...
		var puntos = [120, 344, 109, 257, 476, 350, 120, 190, 210, 450, 430, 170];
